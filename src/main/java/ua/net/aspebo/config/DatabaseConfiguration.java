package ua.net.aspebo.config;

import ua.net.aspebo.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("ua.net.aspebo.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("ua.net.aspebo.repository.search")
